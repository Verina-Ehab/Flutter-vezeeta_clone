...
class AppBarThemeManager {
  ...
  static AppBarTheme lightAppBarTheme = AppBarTheme(
    ...
    iconTheme: const IconThemeData(color: ColorsManager.grey, size: 24),
    actionsIconTheme: const IconThemeData(color: ColorsManager.grey, size: 24),
    titleTextStyle: TextThemeManager.darkTextTheme.headlineMedium,
  );
